...
function EvaluatingLoadingDiv() {
  return (
    <>
      ...
      <motion.div className="z-10 absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 border p-5 rounded-2xl border-[#6C63FF]/10 bg-[#6C63FF]/20 flex flex-col gap-3 justify-center items-center text-center">
